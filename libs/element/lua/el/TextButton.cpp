...
#include <element/lua/widget.hpp>
...
int luaopen_el_TextButton (lua_State* L) {
    using element::lua::TextButton;

    auto T = element::lua::new_widgettype<TextButton> (L, LKV_TYPE_NAME_TEXT_BUTTON,
        sol::meta_method::to_string, [](TextButton& self) {
            return element::lua::to_string (self, LKV_TYPE_NAME_TEXT_BUTTON);
        },
