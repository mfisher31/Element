...
/// LUA CONSOLE - copied and modified from lua v5.3
/*
** $Id: lua.c $
...
#define LUA_PROGNAME "element lua"
#endif
...
#define LUA_VERSUFFIX "versuffix"
#endif
...
int element_console_main (lua_State* L, int argc, const char** argv)
{
    int status, result;
    if (L == NULL)
    {
    ...
    lua_pushlightuserdata (L, (void*) argv); /* 2nd argument */
